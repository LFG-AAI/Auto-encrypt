...
def encrypt_and_rename_file(input_filename, output_filename):
    try:
        ...
        print(f"File {input_filename} berhasil dienkripsi dan disimpan sebagai {compiled_filename}")

    except Exception as e:
        print(f"Terjadi kesalahan saat mengenkripsi file {input_filename}: {str(e)}")

if __name__ == "__main__":
    print(__doc__)  # Menampilkan intro saat skrip dijalankan
